...
function export_dataset {
  ...
  nice mvn $4 -pl $1 -P$3 -Dneo4j.data.dir=$RAM_GRAPH_DIR -Dgithub.client.id=$GITHUB_CLIENT_ID -Dgithub.client.secret=$GITHUB_CLIENT_SECRET -Ddataset.dir=${ELTON_DATASET_DIR} -Dglobi.taxa.version=0.3
