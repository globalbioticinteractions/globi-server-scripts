...
sudo cp /var/lib/globi/.m2/settings-public.xml /etc/globi/.m2/settings-public.xml
sudo cp /var/lib/globi/.m2/settings.xml.template /etc/globi/.m2/settings.xml
sudo chown globi:globi /etc/globi/.m2/settings-public.xml
sudo chown globi:globi /etc/globi/.m2/settings.xml
sudo chmod 600 /etc/globi/.m2/settings-public.xml
